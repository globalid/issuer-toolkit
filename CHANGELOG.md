...
- Sending a credential offer is automatically retried in the case where the credential request has not been fully processed.
...
[unreleased]: https://github.com/globalid/issuer-toolkit/compare/v0.3.1...HEAD
[0.3.1]: https://github.com/globalid/issuer-toolkit/compare/v0.3.0...v0.3.1
